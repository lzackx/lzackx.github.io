...
![Configurations](../images/2020-07-01-flutter-debug-configurations.png)

2. 在连接前填写映射过端口的`Dart VM Observatory`地址

![Dart Remote Debug](../images/2020-07-01-flutter-debug-connect.png)

3. 连接成功会如途中1所示,标记2的按钮可以点击打开网页版的`Dart VM Observatory`.

![Dart Remote Debug connected](../images/2020-07-01-flutter-debug-connected.png)

4. 现在可以通过`flutter attach`按钮进入调试Root Isolate的阶段.

![flutter attach](../images/2020-07-01-flutter-debug-connected-attach.png)

5. `flutter attach`连接成功后会如标记1所示,VM与真机数据互通,这时候就可以实现断点调试(标记1)、热重载(标记2)、热重启(标记3)等的开发方式了.

![Dart Remote Debug](../images/2020-07-01-flutter-debug-connected-attached.png)
...
![Dart Remote Debug](../images/2020-07-01-flutter-performance.png)
...
![without-provider](../images/2020-07-01-flutter-performance-without-provider.png)
...
![without-provider](../images/2020-07-01-flutter-performance-with-provider.png)
