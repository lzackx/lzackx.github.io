...
1. 现在可以通过`flutter attach`按钮进入调试Root Isolate的阶段.
...
![without-provider](http://lzackx.github.io/images/2020-07-01-flutter-performance-without-provider.png?raw=true)
